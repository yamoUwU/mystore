...
<!-- سكربت تحسين الأداء -->
<script src="{{ Theme::asset()->url('js/performance-optimization.js') }}"></script>

<!-- سكربت تفعيل اللغة العربية -->
<script src="{{ Theme::asset()->url('js/arabic-language-activator.js') }}"></script>
</body>
</html>
